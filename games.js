...
const quiz=[
    {
        question:`In which World Cup did Diego Maradona score his infamous
        "Hand of God" goal?`,
        ans:"World cup 1986,Mexico"
    },
    {
        question:`Where is Sharjah Cricke Stadium ?`,
        ans:"UAE ( United Arab Emirates )",
    },
    {
        question: `With 365 goals, who holds the record for top Bundesliga
        goalscorer of all time?`,
        ans: "Gerd Müller"
    },
    {
        question: "Who scored the fastest goal ever scored in French Ligue 1 ?",
        ans: "Kylian Mbappe (8 seconds)"
    },
    {
    ...
    {
        question: `When did Nepal for the first time participate in the One day
        International competition ?(year only)`,
        ans: "2075 B.S. (2018 A.D.) "
    },
    {
        question: "Where did chess originate from ?",
        ans: "India"
    },
    {
        question: `Who bowled the fastest delivery ever in a cricket match ?`,
        ans: "Shoaib Akhtar"
    },
    {
        question: `Which is the first European Country to win the World Cup
        Football ?`,
        ans: "Italy"
    },
